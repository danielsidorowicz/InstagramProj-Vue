<template>
    <div class="loginBlock">
        <Message v-show="err401" severity="error"
            style="background-color: transparent; border-color: #6235d8; color: #6235d8;" @click="closeErr401">{{
                errorMessage }}</Message>
        <Message v-show="err404" severity="error"
            style="background-color: transparent; border-color: #6235d8; color: #6235d8;" @click="closeErr404">{{
                errorMessage }}</Message>
        <Message v-show="status === 'valid'" severity="success"
            style="background-color: transparent; border-color: #6235d8; color: #6235d8;">Account verified</Message>
        <div class="loginDiv">
            <h1>Zaloguj Się</h1>
